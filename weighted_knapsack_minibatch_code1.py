...
"""
prefix = 'relu_minibatch_fixed_c'
capacities = [12, 24, 48, 72, 96]
kfolds = [0, 1, 2, 3, 4]
test_boolean = [1,0]
test_knapsack_weighted(max_step_size_magnitude=0, min_step_size_magnitude=-1, capacities=capacities, dnl_epoch=10,
                       regression_epoch=10, core_number=8, learning_rate=0.01, dnl_learning_rate=1, mini_batch_size=32,
                       n_iter=2, file_name_prefix_phrase=prefix, kfolds=kfolds, dnl_batch_size=32, test_boolean=test_boolean)
prefix = 'greedy_relu_minibatch_fixed_c'
capacities = [12, 24, 48, 72, 96]
kfolds = [0, 1, 2, 3, 4]
test_boolean = [0,1]
test_knapsack_weighted(max_step_size_magnitude=0, min_step_size_magnitude=-1, capacities=capacities, dnl_epoch=10,
