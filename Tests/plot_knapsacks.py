...
if __name__ == '__main__':
    ...
    dest_file_name = 'strong_corr_w_knapsackrun_qptlthin_ng.pdf'
    # capacities = [12, 24, 48, 72, 96, 120, 144, 172, 196, 220]
    capacities = [12, 24, 96, 172, 196, 220]
    weighted_knapsack_template(file_folder=file_folder, models=[1, 0, 1, 1, 1, 1, 1, 1, 1], capacities=capacities,
                               is_plot=False,
                               plot_title=plot_title, is_save=True, dest_file_name=dest_file_name,
    ...
    # weighted_knapsack_template(file_folder=file_folder, capacities=capacities, models=[1, 0, 1, 1, 1, 1, 1, 1, 1], w_tag_str="",
    ...
    dest_file_name = 'strong_corr_w_knapsack_qptlthin_ng.pdf'

    # capacities = [12, 24, 48, 72, 96, 120, 144, 172, 196, 220]
    capacities = [12, 24, 96, 196, 220]
    weighted_knapsack_template(file_folder=file_folder, models=[1, 0, 1, 1, 1, 1, 1, 1, 1], capacities=capacities,
                               is_plot=False,
                               plot_title=plot_title, is_save=True, dest_file_name=dest_file_name, ylim=2,
                               is_run_time=False)
