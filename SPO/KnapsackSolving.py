...
def solveKnapsackGreedily(profits, weights, capacity):
    ...
    for i in range(n_items):
        ...
        assignments[
            items[i][2]] = 1  # note that you selected this item; items[i][2] indicates the original index of the item
...
def regret_knapsack(grpY_true, grpY_pred, weights='uniform', cap=10, assignments_true=None, relaxation=False):
    ...
    if assignments_true is None:
        vals_true, assignments_true = eval_knapsack(grpY_true, grpY_true, weights=weights, cap=cap,
