...
def SPO_load2(train_set, test_set, n_iter=10, instance_number=1, opt_params=None, file_name_prefix='empty',
              dest_folder="Tests/icon/Easy/kfolds/spo/", time_limit=12000, epoch_limit=1, layer_params = None):
        ...
        for w in warmstart_hyperparams:
            for h in H_list:
                for i in range(n_iter):
                    ...
                    clf = SGD_SPO_generic(solver=Gurobi_ICON,layer_params = layer_param, accuracy_measure=False, relax=True,
