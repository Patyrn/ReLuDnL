...
def SPO_load1(train_set, test_set, n_iter=10, instance_number=1, opt_params=None, file_name_suffix='empty',
...
#     SPO_load1(train_set, test_set, n_iter=10, instance_number=1, opt_params=None, file_name_suffix='empty',
#               dest_folder="Tests/icon/Easy/kfolds/spo/", time_limit=12000, epoch_limit=1)