...
class SGD_SPO_generic:
    def __init__(self, param, solver, reset, presolve, relax=False, validation_relax=False, test_relax=False,
                 ...
                 optimizer=optim.Adam, model_save=False, layer_params = None, model_name=None, method=-1, warmstart=False,  # obj_cut=-1,
                 **hyperparam):
    ...
    def fit(self, x_train, y_train, x_validation=None, y_validation=None, x_test=None, y_test=None):
        ...
        if not self.model:
            if self.layer_params is None:
                ...
                self.model = DynamicRegression(self.layer_params)  #
        # loss
