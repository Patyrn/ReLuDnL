...
for param_divider in param_dividers:
    for layer_params in layer_params_list:
        test_knapsack_weighted(max_step_size_magnitude=0, min_step_size_magnitude=-1, capacities=capacities, dnl_epoch=5, layer_params=layer_params,
                               params_per_epoch_divider=param_divider, file_folder=file_folder,
